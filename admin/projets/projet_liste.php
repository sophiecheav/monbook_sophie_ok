...
<div class="menu">
    ...
    <a href="<?php echo BOOK_URL_SITE ?>admin/projets/projet_formulaire.php">Ajouter un projet</a>
</div>
    ...
    <?php
      ...
      if (count($listeProjets) == 0) {
        ...
        foreach ($listeProjets as $projetSeul) {
          $lienModifier = html_a("Modifier", BOOK_URL_SITE . "admin/projets/projet_formulaire.php?projetAAfficher=$projetSeul[id_projet]");
